...
export type UseStylusReadConfig<
  TContractName extends ContractName,
...
> = {
  ...
  } & UseStylusArgsParam<TContractName, TFunctionName> &
    Omit<UseContractReadConfig, "chainId" | "abi" | "address" | "functionName" | "args">
>;

export type UseStylusWriteConfig<
  TContractName extends ContractName,
...
export type UseStylusEventConfig<
  TContractName extends ContractName,
...
export type UseStylusEventHistoryConfig<
  TContractName extends ContractName,
  TEventName extends ExtractAbiEventNames<ContractAbi<TContractName>>,
...
export type UseStylusEventHistoryData<
  TContractName extends ContractName,
  TEventName extends ExtractAbiEventNames<ContractAbi<TContractName>>,
  TBlockData extends boolean = false,
  TTransactionData extends boolean = false,
